...
public class Escalabilidad {
    ...
    public Escalabilidad(Escalabilidad es){
        this.id = es.getId();
        this.incrementoDanyoNivel = es.getIncrementoDanyoNivel();
        this.incrementoDefensaNivel = es.getIncrementoDefensaNivel();
        this.incrementoSaludNivel = es.getIncrementoSaludNivel();
        this.incrementoManaNivel = es.getIncrementoManaNivel();
    }
