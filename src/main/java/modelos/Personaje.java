...
public class Personaje {
    ...
    public Personaje(Personaje pe){
        this.id = pe.getId();
        this.nombre = pe.getNombre();
        this.descripcion = pe.getDescripcion();
        this.fechaCreacion = pe.getFechaCreacion();
        this.nivel = pe.getNivel();
        this.vidaBase = pe.getVidaBase();
        this.manaBase = pe.getManaBase();
        this.defensaBase = pe.getDefensaBase();
        this.defensa = pe.getDefensa();
        this.ataqueBase = pe.getAtaqueBase();
        this.ataque = pe.getAtaque();
        this.vida = pe.getVida();
        this.mana = pe.getMana();
        this.region = pe.getRegion();
        this.habilidades = pe.getHabilidades();
        this.equipamiento = pe.getEquipamiento();
        this.escalabilidad = pe.getEscalabilidad();
